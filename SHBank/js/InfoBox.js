...
(function () {
    ...
    baidu.object.extend(InfoBox.prototype, {
        ...
        _setContent: function (content) {
            ...
            //var closeHtml = this._getCloseIcon(); 去掉弹出框的关闭按钮
            //string类型的content
        ...
        _adjustPosition: function (poi) {
            ...
            switch (this._opts.align) {
                case INFOBOX_AT_TOP:
                    if (this._marker) {
                        this._div.style.bottom = -(pixel.y - this._opts.offset.height - icon.anchor.height + icon.infoWindowAnchor.height) - this._marker.getOffset().height + 30 + "px";
                    } else {
